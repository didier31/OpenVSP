...
//==== Constructor ====//
FuselageScreen::FuselageScreen( ScreenMgr* mgr ) : ChevronScreen( mgr, 400, 715, _("Fuselage") )
{
    ...
    m_DesignLayout.AddSlider( m_LengthSlider, _("Length"), 10, "%6.5f" );

    m_DesignLayout.AddYGap();
    m_DesignLayout.AddDividerBox( _("Design Policy") );
    m_DesignPolicyChoice.AddItem( _("MONOTONIC") );
    ...
    m_XSecLayout.AddSlider( m_XSecXSlider, _("X"), 1.0, "%6.5f" );
    m_XSecLayout.AddSlider( m_XSecYSlider, _("Y"), 1.0, "%6.5f" );
    m_XSecLayout.AddSlider( m_XSecZSlider, _("Z"), 1.0, "%6.5f" );
    m_XSecLayout.AddYGap();
